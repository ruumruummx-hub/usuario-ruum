...
export default function ViewCuenta() {
  ...
  return (
    <div className="fade-in p-5 pb-24">
      ...
      {/* Perfil */}
      <div className="bg-white border border-slate-200 rounded-xl p-5 mb-6 flex flex-col text-center sm:flex-row sm:text-left items-center gap-4">
      ...
      <div className="space-y-2 mb-6">
        ...
        >
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0 text-left">
              <span className="text-sm font-medium text-slate-700 block truncate">Mis vehículos y viajes</span>
              {viajesActivos > 0 && (
        ...
        <button className="w-full bg-white border border-slate-200 rounded-xl p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <span className="truncate text-sm font-medium text-slate-700">Facturación</span>
          </div>
          <FontAwesomeIcon icon={faChevronRight} className="text-slate-400 text-xs" />
        </button>
        ...
        <button className="w-full bg-white border border-slate-200 rounded-xl p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <span className="truncate text-sm font-medium text-slate-700">Notificaciones</span>
          </div>
          <FontAwesomeIcon icon={faChevronRight} className="text-slate-400 text-xs" />
        </button>
        ...
        <button className="w-full bg-white border border-slate-200 rounded-xl p-4 flex items-center justify-between hover:bg-slate-50 transition-colors">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <span className="truncate text-sm font-medium text-slate-700">Soporte y Ayuda</span>
          </div>
          <FontAwesomeIcon icon={faChevronRight} className="text-slate-400 text-xs" />
        </button>
      </div>
